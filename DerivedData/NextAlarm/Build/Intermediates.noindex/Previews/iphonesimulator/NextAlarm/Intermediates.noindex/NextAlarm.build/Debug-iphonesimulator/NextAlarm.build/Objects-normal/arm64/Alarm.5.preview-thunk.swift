...
#sourceLocation(file: "/Users/jasonwan/Code/Personal Projects/NextAlarm/NextAlarm/Alarm.swift", line: 101)
...
extension Alarm {
    ...
    //                        .foregroundColor(Color(red: 137/255, green: 187/255, blue: 1))
                            ...
                            .padding(.bottom, __designTimeInteger("#5231.[1].[1].property.[0].[0].arg[0].value.[1].arg[0].value.[0].arg[0].value.[0].arg[0].value.[0].modifier[4].arg[1].value", fallback: 0)), "#5231.[1].[1].property.[0].[0].arg[0].value.[1].arg[0].value.[0].arg[0].value.[0].arg[0].value.[0]")
                ...
                // List
                   __designTimeSelection(List {
                       __designTimeSelection(Section(header:
                                   __designTimeSelection(Text(__designTimeString("#5231.[1].[1].property.[0].[0].arg[0].value.[1].arg[0].value.[1].arg[0].value.[0].arg[0].value.arg[0].value", fallback: "Swipe right to delete, Tap alarm to edit"))
                                     .font(.subheadline)
                                     .foregroundColor(.white)
                                     .padding(.bottom, __designTimeInteger("#5231.[1].[1].property.[0].[0].arg[0].value.[1].arg[0].value.[1].arg[0].value.[0].arg[0].value.modifier[2].arg[1].value", fallback: 5))

                                     .background(__designTimeSelection(Color.black, "#5231.[1].[1].property.[0].[0].arg[0].value.[1].arg[0].value.[1].arg[0].value.[0].arg[0].value.modifier[3].arg[0].value"))
                                     .bold(), "#5231.[1].[1].property.[0].[0].arg[0].value.[1].arg[0].value.[1].arg[0].value.[0].arg[0].value")
                   ...
                   .listStyle(.grouped), "#5231.[1].[1].property.[0].[0].arg[0].value.[1].arg[0].value.[1]")
